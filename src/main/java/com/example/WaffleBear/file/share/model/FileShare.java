...
@AllArgsConstructor
@Table(indexes = {
        @Index(name = "idx_file_share_file", columnList = "file_idx"),
        @Index(name = "idx_file_share_owner", columnList = "owner_idx"),
        @Index(name = "idx_file_share_recipient", columnList = "recipient_idx")
})
