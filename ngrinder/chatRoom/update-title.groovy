...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://172.18.0.5:8080/chatRoom') // http://172.18.0.5:8080/chatRoom
    ...
    void test() {
        def response = patchJson('/chatRoom/' + propLong('roomId', 1L) + '/title', [
                title: prop('roomTitle', uniqueValue('ngrinder-room-renamed'))
        ])
