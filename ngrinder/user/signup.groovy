...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://172.18.0.5:8080/user') // http://172.18.0.5:8080/user
    ...
    void test() {
        def response = postJson('/user/signup', [
                email   : prop('signupEmail', uniqueEmail('ngrinder')),
                name    : prop('signupName', uniqueValue('ngrinder-user')),
