...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://172.18.0.5:8080/feater') // http://172.18.0.5:8080/feater
    ...
    void test() {
        def payload = multipartPayload([
                [name: 'image', filename: prop('profileFileName', uniqueValue('profile') + '.png'), contentType: 'image/png', bytes: samplePngBytes()]
        ])
