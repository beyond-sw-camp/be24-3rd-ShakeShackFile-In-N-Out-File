 ...
 * This keeps Authorization in use until a real WebSocket harness is added.
 */

@RunWith(GrinderRunner)
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://172.18.0.5:8080/ws-stomp') // http://172.18.0.5:8080/ws-stomp
