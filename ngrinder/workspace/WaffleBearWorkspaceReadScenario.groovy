...
class WaffleBearWorkspaceReadScenario {
    ...
    static void beforeProcess() {
        ...
        loginTest = new GTest(1, "workspace-read-login")
        endpointTest = new GTest(2, "workspace-read-endpoint")
    ...
    void testWorkspaceRead() {
        ...
        Map created = createWorkspace("read")
        try {
            HTTPResponse response = get(endpointRequest, "/workspace/read/${created.idx}")
