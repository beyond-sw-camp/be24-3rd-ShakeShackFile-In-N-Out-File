...
class WaffleBearWorkspaceListScenario {
    ...
    static void beforeProcess() {
        ...
        loginTest = new GTest(1, "workspace-list-login")
        endpointTest = new GTest(2, "workspace-list-endpoint")
    ...
    void testWorkspaceList() {
        ...
        HTTPResponse response = get(endpointRequest, "/workspace/list")
