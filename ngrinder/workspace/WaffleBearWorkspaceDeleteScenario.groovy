...
class WaffleBearWorkspaceDeleteScenario {
    ...
    static void beforeProcess() {
        ...
        loginTest = new GTest(1, "workspace-delete-login")
        endpointTest = new GTest(2, "workspace-delete-endpoint")
    ...
    @Test
    void testWorkspaceDelete() {
        if (skipNetwork) {
            return
        }
        Map created = createWorkspace("delete")
        HTTPResponse response = post(endpointRequest, "/workspace/delete/${created.idx}", null)
